...
```{r fig2, fig.height=4, fig.width=6, fig.align="center", include=TRUE, echo=FALSE}
...
ggplot(datatograph, aes(x =year, y =count)) + geom_bar(stat = "identity", width=.2) +
  labs(
    ...
    subtitle = "On Topics of Social Policy, Domestic Policy, or Political Administrations/Figures"
  )
```

```{r practice, include = TRUE, echo=FALSE}

plot1<- ggplot(data=adj2dataset, mapping=aes(x=PubYr, y=case_count)) + geom_point() + geom_smooth() + labs(x="Year", y="Count", color=NULL, title="Figure 2: Yearly # of Op-Eds Published by Retired Military Officers", subtitle="On Topics of Social Policy, Domestic Policy, or Political Administrations/Figures")
plot2 <- ggplot(data=adj2dataset, mapping=aes(x=PubYr, y=prop_yr)) + geom_point() + geom_smooth() + labs(x="Year", y="Count", color=NULL, title="Figure 2: Proportion of Total Op-Eds Published by Retired Military Officers ", subtitle="On Topics of Social Policy, Domestic Policy, or Political Administrations/Figures")
...
ggplot(datatograph, aes(x =decade, y =numcount)) + geom_bar(stat = "identity", width=.2) +
  labs(
    ...
    color = NULL,
    title = "Figure 4: # of Op-Eds Written By Military Retirees",
