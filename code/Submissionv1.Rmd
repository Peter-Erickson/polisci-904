...
Finally, if one believes that today's polarization is different in degree and kind than previous eras of polarization, which has been argued in this paper, one must also recognize that the military will continue to face challenges as a result of political polarization. The events following the death of George Floyd certainly have revealed this.  
\singlespace
\pagebreak
