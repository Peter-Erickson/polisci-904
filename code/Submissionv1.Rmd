...
My theory holds that when military credibility is high, a demand signal is created by the American public such that future interactions between military elites and the military institution are encouraged and welcomed. There are numerous ways in which these interactions might satisfy the public's demand to observe or hear from the military. Institutionally, the military might respond to the public's demand signal for increased engagement by participating in public ceremonies, parades, and other showcases of military prowess (i.e. at sporting venues). Individually, military elites, especially retired military officers, would be more eager to dialogue with the American public when military credibility is high. Press and media outlets would be more eager to showcase elite military voices when military credibility is high because they represent an institution that commands a high degree of public respect. When military credibility is low, the opposite will occur. Since demand for interactions between the American public and the military is muted, the institution will not participate in a high number of public showcases of military prowess because there will not be as strong of a demand signal sent by the public. In short, military credibility and respect for military expertise impacts the likelihood of the military institution interacting with the American public. When respect for the military is high, the military is likely to speak out and to interact with the public, and when respect for the military is low, the military is less likely to do so. 

When political polarization is high, I contend that it ultimately places great strain on the concept and definition of loyalty because the distinction between what is considered morally right or wrong and partisan expression becomes blurred if not altogether removed. The result is a less unified military institution. I further contend that these mechanisms work as the logical and expected outworking of the characteristics of the polarized American political environment. While scholarly literature has looked at how the military faces pressure stemming from divided institutional loyalties [@betts_soldiers_1991], the dynamic of polarization promises to add even more pressure and scrutiny on the loyalty of individual officers and the military as a whole.

I contend that the the line between what is considered by individuals to be morally right and wrong and sentiments of partisan expression becomes blurred in highly polarized environments. As discussed above, political polarization has caused Americans to move further apart ideologically on an increasing number of issues [@layman_party_2006], including on core attitudes regarding issues such as race and immigration that are central to one's identity [@sides_identity_2018]. In this environment, individuals believe the stakes are raised to a very high level for a number pivotal concerns. Individuals in a polarized environment, I contend, also believe there are enormous consequences if the specific side with which they ally on any given issue loses to the other side because the other side is not just simply mistaken, but deeply and morally wrong. 

This dynamic impacts military officers in a unique way because military officers, unlike regular citizens, operate under strict codes of loyalty all of the time. The American military officer, for example, takes an oath to support and defend the Constitution of the United States. In a polarized environment, two different officers may adopt completely different stances on a contentious issue, each believing the other is morally wrong and operating outside of the framework of the constitution. Each officer, then, might accuse the other of failing to be loyal to the ideals of the military. As a result, when polarization is high, the likelihood of partisan expression is high because in doing so, members of the military institution may feel that doing so is the right and loyal thing to do. 

As a quick case in point, consider that in June 2020, following President Trump's largely unpopular move of displacing protesters from Lafayette Square, a letter published by West Point alumni expressly called out prominent West Point alumni serving in the Trump administration. Though it did not mention individuals by name, the letter was intended and acknowledged by media as directed towards the Secretary of Defense, Mark Esper, and the Secretary of State, Mike Pompeo, who are both graduates of West Point's Class of 1986 [@gaouette_group_nodate]. The charges of the letter were both damning and politically striking: "...We are concerned that fellow graduates serving in senior-level, public positions are failing to uphold their oath of office and their commitment to Duty, Honor, Country"[@noauthor_letter_2020]. The letter's clear implication is that if you are serving in the Trump administration and if you graduated from the US Military Academy (i.e. Esper and Pompeo), you have forsaken your oath of office, the US Constitution, and the values that West Point stands for. 

Ultimately, four possible worlds exist when the impacts of military credibility and political polarization are considered in tandem (see Table 1, below). The first is...the second is...The third is....and the fourth is....
...
The second, and perhaps more important dynamic, is understanding the impacts of the polarized environment on the military's ability to perform its primary military task, i.e. fight and win the nation's wars. Scholars, military officers, and practitioners must better understand what impacts, if any, are placed on military and civilian leaders as a result of political polarization on the development and implementation of war goals, aims, and strategies, and how military leaders and civilian policymakers can overcome these hurdles to generate effective policies [@rapp_civil-military_2015].  
