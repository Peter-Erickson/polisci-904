...
Figure 1, below, shows describes a theory for how the variables of political polarization, institutional credibility, military professionalism, and other military outcomes may relate to each other. From left to right, the theory contends that increasing political polarization ultimately reduces military professionalism. At the same time, however, there is an intervening variable, institutional credibility, that may actually increase as a result of increasing political polarization. Finally, on the far right of the diagram, are changes in military outcomes. Though it is outside of the scope of this paper, I contend that eventually, increases in political polarization may at some point cause discernible changes in various military outcomes. These military outcomes may vary, but could include things such as military effectiveness, to include the military's ability to fight and win battles [@talmadge_dictators_2015] and to formulate sound strategic advice [@rapp_civil-military_2015]. Indeed, the full degree to which and in what ways polarization will impact the military are not yet fully known. 
...
problem_dag %>% tidy_dagitty() %>% 
  ...
  geom_dag_point()+
  geom_dag_text()+ 
  geom_dag_label_repel(aes(label=label, fill=label), col="white", show.legend=FALSE)+ theme_dag() + labs(title="Figure 1", subtitle="The Impact of Political Polarization on Military Professionalism")
