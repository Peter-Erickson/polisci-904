...
The credibility of the American military as an institution has increased during the past fifty years. In the late 1970s, likely as a result of public opinion over the Vietnam War, 54% of Americans indicated that they trusted the military "a great deal or quite a lot," whereas in 2019, 73% of Americas expressed the same sentiments [@gallup_polls_confidence_2007]. Between these time periods, there have been some shorter and localized changes, but by and large, the increase that has occurred has been gradual and steady. Today in fact, relative to other government institutions, the American public trusts the military to a remarkably high degree. For example, according to a recent Pew Research Center poll, 80% of the American public expects the military to act in the best interests of the American public, compared to tho percentage who believe the same about business leaders (45%), the media (40%), and elected officials (25%) [@johnson_trust_2018].  
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|p{5cm}|}
    \hline
    \textbf{Characteristics of Increasing Political Polarization} & \textbf{Description} & \textbf{Resulting Strain on Military Professionalism}  \\ \hline
    \textbf{Conflict Extension} & Less politically-neutral space exists as partisan disagreements subsume a greater number of issues & Military Professionals face an increasingly difficult prospect of remaining apolitical. \\ \hline
    \textbf{Negative Partisanship} & Strong feelings of personal dislike and disdain for those who hold to opposing political views and who are on the "other side" & Greater willingness to confront or take issue with those with opposing views\\ \hline
    \textbf{Core and dearly-held issues are increasingly at stake} & The salience of one's identity and belonging to a particular group is raised; Belief that moral right and wrong are at stake & Changes in one's concept of loyalty \\ \hline
\end{tabular}
...
_$H_2$: Because overall newspaper consumption has dropped in the past 40 years, there will be fewer opinion pieces over time authored by retired military officers._

_$H_3$: Given that polarization has become increasingly pronounced in the United States over the time period examined, there will be an increase in recent years in the number of op-eds which reveal political and partisan sentiments, indicating a drop in military professionalism._ 

# First Layer Analysis: Topics Addressed by Retired Military Officers

In the first level of analysis, I code each observation into one of several binary categories that corresponds to the overall subject of the publication. The goal is to create a coding scheme that captures a concise number of topical descriptions that are still sufficiently broad enough to reveal variation in the topic addressed by retired military authors. I develop a total of six topical variables, and each observation takes on the value of 1 if the publication corresponds to the general definition of the variable, and 0 otherwise.
...
predictiondatafut <- tibble(House_distance_dim1=seq(min(slimdata$House_distance_dim1), 1, by=.01), Inst_Cred_Gallup = mean(slimdata$Inst_Cred_Gallup)) %>%
crossing(Ques_Prof = c(0,1))
