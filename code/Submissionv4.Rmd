...
stargazer(mod3, mod4, 
          ...
          column.labels = c('Legislative Activity, Criticize, or Partisan','Criticize or Partisan'),
          covariate.labels = c('Institutional Credibility', 'Congressional Polarization', 'Male', 'Mixed Authorship', 'Unknown Authorship', 'Rank'),
          align=TRUE)
