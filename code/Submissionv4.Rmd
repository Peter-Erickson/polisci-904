...
dataset %>% print()
# Only read in the first 354 rows - is there a better way to get rid of N/A data?

# Replace NA with 0 in the data for variables letter_ed to online_only, and leg_act #to role
adjdataset <- dataset[1:353,] %>%
  mutate_at(
...
ggplot(data=adjdataset, aes(x=PubYr, y=Yrcount)) + geom_point() + geom_line() + geom_smooth(method="loess") + labs(
  x="Year", 
  y="yearly count", 
  title="Figure Two: Number of Op-Eds Published by Retired Military\n Officers (WSJ, NYT, WaPo, USA Today, LA Times)",
  subtitle= "1979-2020",
  caption="Note: As of 29 October 2020"
...
## Do a couple of things here.  Create several new variables.  
# The first is a variable called case-count that counts the number of times by publishing #year an article published that calls for legislative action, criticizes or is #insubordinate, or is blatantly partisan. The second variable, prop_yr, is simply a 
...
plot1<- ggplot(data=adjdataset, mapping=aes(x=PubYr, y=prop_yr)) + geom_point() + geom_smooth() + labs(x="Year", y="Annual Proportion", color=NULL) + geom_vline(xintercept = 1981, size=.2, colour="tomato") + 
  geom_vline(xintercept=1989, size=.2, colour="tomato") + 
  geom_vline(xintercept=1993, size=.2, colour="dodgerblue") + geom_vline(xintercept=2001, size=.2, colour="tomato") + 
  geom_vline(xintercept=2009, size=.2, colour="dodgerblue") +
  geom_vline(xintercept=2017, size=.2, colour="tomato") +
  ...
  geom_text(aes(x=2017, label="Trump",y=0), colour="tomato", angle=90, vjust=1, text=element_text(size=9))  
  
plot2 <- ggplot(data=adjdataset, mapping=aes(x=PubYr, y=dom_pol_prop)) + geom_point() + geom_smooth() + labs(x="Year", y="Proportion", color=NULL)+ geom_vline(xintercept = 1981, size=.2, colour="tomato") + 
  geom_vline(xintercept=1989, size=.2, colour="tomato") + 
  geom_vline(xintercept=1993, size=.2, colour="dodgerblue") + geom_vline(xintercept=2001, size=.2, colour="tomato") + 
  geom_vline(xintercept=2009, size=.2, colour="dodgerblue") +
  geom_vline(xintercept=2017, size=.2, colour="tomato") +
...
grid.arrange(plot1, plot2, ncol=2, top="Figure 3: Proportion of Op-Eds Published Which\n (L) Call for Legislative Action, Criticize Civilian Leaders, or are Partisan\n in nature; or (R) Address Domestic Political Topics")
```
